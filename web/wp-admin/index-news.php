...
<div class="blog-section">
	<div class="container">
		...
		if( $news_setting['home_slider_post_enable']==false ) 
		{
			$args = array( 'post_type' => 'post','ignore_sticky_posts' => 1 , 'category__not_in'=>$news_setting['slider_select_category'], 'posts_per_page' => $no_of_post);
		}
		else
		{
