...
// Creating the widget
	...
	<h4 for="<?php echo $this->get_field_id( 'fa_icon' ); ?>"><?php _e( 'Icon','appointment' ); ?></h4>
	...
	<span><?php _e('Get your Font Awesome','appointment'); echo " ";?><a href="http://fortawesome.github.io/Font-Awesome/icons/" target="_blank" ><?php _e('here','appointment'); ?></a></span>
	
	<h4 for="<?php echo $this->get_field_id( 'description' ); ?>"><?php _e( 'Description','appointment' ); ?></h4>
	<input class="widefat" id="<?php echo $this->get_field_id( 'description' ); ?>" name="<?php echo $this->get_field_name( 'description' ); ?>" type="text" value="<?php if($description) echo esc_attr($description); else echo '+82 334 843 52';?>" /><br><br>
